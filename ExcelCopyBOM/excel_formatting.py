...
COLUMN_WIDTHS = {
    ...
    'E': 93 / 7.5,  # Description 2
    'F': 115 / 7.5,  # BOM Structure
    'G': 423 / 7.5,  # Description
    'H': 135 / 7.5,  # Material
    'I': 173 / 7.5,  # Standard/PED
    'J': 48 / 7.5,  # QTY
    'K': 82 / 7.5,  # Total QTY
    'L': 39 / 7.5,  # Weight
    'M': 39 / 7.5,  # Surface Area
    'N': 39 / 7.5,  # Volume
    'O': 200 / 7.5,  # Comment
    'P': 94 / 7.5,  # Drawings
}
...
# Kolonne justeringer
COLUMN_ALIGNMENTS = {
    'A': CENTER_ALIGNMENT,  # Item
    'B': LEFT_ALIGNMENT,    # Part Number
    'C': CENTER_ALIGNMENT,  # Rev
    'D': LEFT_ALIGNMENT,    # Description 1
    'E': LEFT_ALIGNMENT,    # Description 2
    'F': LEFT_ALIGNMENT,    # BOM Structure
    'G': LEFT_ALIGNMENT,    # Description
    'H': LEFT_ALIGNMENT,    # Material
    'I': LEFT_ALIGNMENT,    # Standard/PED
    'J': CENTER_ALIGNMENT,  # QTY
    'K': CENTER_ALIGNMENT,  # Total QTY
    'L': CENTER_ALIGNMENT,  # Weight
    'M': CENTER_ALIGNMENT,  # Surface Area
    'N': CENTER_ALIGNMENT,  # Volume
    'O': LEFT_ALIGNMENT,    # Comment
    'P': LEFT_ALIGNMENT,    # Drawings
}
